...
function updateVisuals() {
    ...
    if (count >= 1000){
        document.querySelector('.up10').classList.add('hid');
    }

    if (count >= 10000){
        document.querySelector('.up100').classList.add('hid');
    }

    if (count >= 100000){
        document.querySelector('.up1k').classList.add('hid');
    }

    if (count >= 1000000){
        document.querySelector('.up10k').classList.add('hid');
    }

    if (count >= 10000000){
        document.querySelector('.up100k').classList.add('hid');
    }

    if (count >= 100000000){
        document.querySelector('.up1m').classList.add('hid');
    }

    if (count >= 1000000000){
        document.querySelector('.up10m').classList.add('hid');
    }

    if (count >= 10000000000){
        document.querySelector('.up100m').classList.add('hid');
    }

    if (count >= 100000000000){
        document.querySelector('.up1b').classList.add('hid');
    }

    if (count >= 1000000000000){
        document.querySelector('.up10b').classList.add('hid');
    }

    if (count >= 10000000000000){
        document.querySelector('.up100b').classList.add('hid');
    }

    if (count >= 100000000000000){
        document.querySelector('.up1t').classList.add('hid');
    }

    if (count >= 1000000000000000){
        document.querySelector('.up10t').classList.add('hid');
    }

    if (count >= 10000000000000000){
        document.querySelector('.up100t').classList.add('hid');
    }

    if (count >= 100000000000000000){
        document.querySelector('.up1q').classList.add('hid');
    }

    if (count >= 1000000000000000000){
        document.querySelector('.up10q').classList.add('hid');
    }
...
if (confirm("Are you sure you want to NUKE THE LEMONS?\n\nThis will delete your progress.")) {
...
function dkp(){
document.getElementById("dkp").innerText = dkpnum;
dkpnum = dkpnum + 12000;
